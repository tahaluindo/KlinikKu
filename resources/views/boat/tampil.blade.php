    ...
    <table id="cashier_data" class="table table-bordered table-striped">
      <thead>
        ...
        <th scope="col" colspan="2">
            ...
            <a href="" onclick="this.href='bt_pdf'" button type="button" class="btn btn-danger" target="_blank"><i class="bi bi-file-pdf"></i></a>
            <a href="" onclick="this.href='bt_export'" button type="button" class="btn btn-success" target="_blank"><i class="bi bi-file-excel"></i></a>
        </th>
        </tr>
        <tr>
        <th scope="col" width="3%">ID</th>
        <th scope="col" width="30%">Kapal</th>
          ...
          $.ajax({
            ...
            success: function(response) {
              if (response.status == 200) {
                Swal.fire(
                  'Added!',
                  'Kapal Added Successfully!',
                  'success'
                )                
                var oTable = $('#cashier_data').dataTable();
                    oTable.fnDraw(false);
              }      
              $("#add_prod_btn").text('Add Kapal');
      ...
      $("#edit_prod_form").submit(function(e) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            $("#edit_prod_btn").text('Update Kapal');
