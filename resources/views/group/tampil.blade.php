...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Kateogori</li>
    </ol>
  </nav>
</div>
    ...
    <table id="group_data" class="table table-bordered table-striped">
      <thead>
        ...
        <th scope="col" colspan="2">
            ...
            <a href="" onclick="this.href='group_pdf'" button type="button" class="btn btn-danger" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Export PDF"><i class="bi bi-file-pdf"></i></a>
            <a href="" onclick="this.href='group_export'" button type="button" class="btn btn-success" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Export Xls"><i class="bi bi-file-excel"></i></a>
        </th>
        </tr>
        <tr>
