    ...
    <table id="cashier_data" class="table table-bordered table-striped">
      <thead>
        ...
        <th scope="col" colspan="3">
            ...
            <a href="" onclick="this.href='cashier_pdf'" button type="button" class="btn btn-danger" target="_blank"><i class="bi bi-file-pdf"></i></a>
            <button type="button" class="btn btn-warning"><i class="bi bi-printer"></i></button>
            <a href="" onclick="this.href='cashier_export'" button type="button" class="btn btn-success" target="_blank"><i class="bi bi-file-excel"></i></a>
        </th>
        </tr>
        <tr>
        <th scope="col" width="3%">ID</th>
        <th scope="col" width="30%">No Rek</th>
       ...
       $(document).on('click', '.editIcon', function(e) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            if (selectedtext == 4) {
              $('#status3').text("KAS KANTOR");
            } else {
              $('#status4').text("KAS PROJECT");
            }
          }
        });
      });
