...
<head>
		...
		<title>Listing Rekening Kas</title>
			...
			<table>
				...
				<tr class="heading">
                    ...
                    @foreach ($cashiers as $row)
						...
						<td width="10%" class="item">{{ $row->no_rek }}</td>
                        <td width="20%" class="item">{{ $row->bank }}</td>
						...
						<td width="10%" class="item3">{{ number_format($row->saldo) }}</td>
						</tr>
