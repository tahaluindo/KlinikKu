...
<div class="pagetitle">
  <h4>Cetak Laporan Rugilaba</h4>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="/home">Home</a></li>
      <li class="breadcrumb-item active">Cetak</li>
      <li class="breadcrumb-item active">Lap Rugilaba</li>
  ...
  <div class="card-body">
    ...
    <form>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                    <select name="id" id="id" class="form-select" aria-label="Default select example">  
                        ...
                        <option value="1">Laporan Rugilaba Bulanan</option>
                    </select>
                </select>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <a href="" onclick="this.href='laporan_rugilaba/' + document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value + '/' + document.getElementById('id').value + '/' + document.getElementById('member_id').value" target="_blank"
