		...
		<div class="invoice-box">
			<table>
                    ...
                    @foreach ($invoice_detail as $row)
						...
						@if (($dok <> $row->doinvoice_id) && ($dok <> 'awal'))
							@if ($qty_semua1 > 0) 
								...
								<td colspan="1"><b>{{ number_format(@array_sum($qty_semua1)) }}</td>
								<td colspan="1"><b>-</td>
						...
						<td width="10%" class="item3">{{ number_format($row->qty) }}</td>
				...
				<tr class="item last">
					...
					<td colspan="1"><b>{{ number_format(@array_sum($qty_semua)) }}</td>
					<td colspan="1"><b>-</td>
