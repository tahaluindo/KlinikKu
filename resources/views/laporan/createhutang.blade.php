...
<div class="pagetitle">
  <h4>Cetak Laporan Hutang</h4>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="/home">Home</a></li>
      <li class="breadcrumb-item active">Cetak</li>
      <li class="breadcrumb-item active">Lap Hutang</li>
  ...
  <div class="card-body">
    ...
    <form>
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <select name="id" id="id" class="form-control" required>
                    <option value="1">Laporan Hutang Rekap</option>
                </select>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <a href="" onclick="this.href='laporan_hutang/' + document.getElementById('id').value" target="_blank"
                ...
                <!--
                <a href="" onclick="this.href='laphutang_export/' + document.getElementById('id').value" target="_blank"
