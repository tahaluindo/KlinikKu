...
<div class="pagetitle">
  <h4>Cetak Laporan Kasir</h4>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="/home">Home</a></li>
      <li class="breadcrumb-item active">Cetak</li>
      <li class="breadcrumb-item active">Lap Mutasi Kas</li>
  ...
  <div class="card-body">
    ...
    <form>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="date" class="form-control" name="tglawal" id="tglawal" onchange='cetakTanggal()' required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="date" class="form-control" name="tglakhir" id="tglakhir" onchange='cetakTanggal()' required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                    <select name="id" id="id" class="form-select" aria-label="Default select example">  
                        ...
                        <option value="1">Laporan Kasir</option>
                    </select>
                </select>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <label class="col-sm-2 col-form-label">Akun Kasir</label>
            <div class="col-sm-10">
                <select name="kasir_id" id='kasir_id' class="form-select" aria-label="Default select example">
                    <option value="">-- Select Akun Kasir--</option>
                    @foreach ($cashiers as $row) 
                        <option value="{{ $row->id }}">{{ $row->no_rek }} -  {{ $row->member->kta }} -  {{ $row->member->name }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <a href="" onclick="this.href='laporan_cashier/' + document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value+ '/' + document.getElementById('id').value + '/' + document.getElementById('kasir_id').value" target="_blank"
