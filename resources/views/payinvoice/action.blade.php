...
<a href="{{ route('payinvoice_index2', ['id' => $payinvoice_id, 'Customer_id' => $customer_id, 'supplier_id' => $supplier_id]) }}" class="text-success mx-1"><i class="bi-pencil-square h5"></i></a>
